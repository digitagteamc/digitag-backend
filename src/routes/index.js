...
const youtubeChannelRoutes = require('../modules/youtubeChannels/youtubeChannel.route');
const adTypeRoutes = require('../modules/adTypes/adType.route');
const celebrityRoutes = require('../modules/celebrities/celebrity.route');
const brandRequirementRoutes = require('../modules/brandRequirements/brandRequirement.route');
...
router.use('/brand-requirements', brandRequirementRoutes);
