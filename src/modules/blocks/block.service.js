    ...
    await Promise.all([
      ...
      prisma.report.create({
        data: {
          ...
          // Moderation trail only — not an explicit report. Without this,
          // blocking someone silently made the app show "Reported" on their
          // profile (and blocked the user from ever submitting a real
          // report on them later), even after unblocking.
          autoGenerated: true,
        },
      }),
    ]);
